      ...
      <section id="contact" className="py-32 px-8 bg-gradient-to-br from-stone-800 via-slate-900 to-stone-900 text-white relative overflow-hidden">
        ...
        <div className="max-w-2xl mx-auto text-center relative z-10">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 px-10 py-4 border-2 border-green-500 text-green-400 text-sm tracking-wider font-medium rounded-lg hover:bg-green-500 hover:text-white transition-all hover:-translate-y-0.5 hover:shadow-lg hover:shadow-green-500/25"
          >
            <span>💬</span> WhatsApp
          </a>
        </div>
